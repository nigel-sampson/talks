            ...
            bool AddHandlerForFirstExistingEvent(params string[] names)
            {
                ...
                foreach (var name in names)
                {
                    ...
                    if (ev != null)
                    {
                        ...
                        ev.AddEventHandler(target, Delegate.CreateDelegate(ev.EventHandlerType, this, GetType().GetTypeInfo().GetMethod("HandleAnyEvent", BindingFlags.NonPublic | BindingFlags.Instance)));
